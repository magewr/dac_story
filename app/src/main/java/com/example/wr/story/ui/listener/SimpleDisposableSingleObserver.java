 ...
 * SingleObserver의 결과값을 편하게 처리하기 위한 클래스로 기본값에 대한 처리가 되어있다.
...
public class SimpleDisposableSingleObserver<T> extends DisposableSingleObserver<T> {
    ...
    public SimpleDisposableSingleObserver(PresenterResultListener presenterResultListener) {
        super();
        this.presenterResultListener = presenterResultListener;
    }

    public SimpleDisposableSingleObserver() {
        super();
    }
